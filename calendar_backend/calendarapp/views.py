...
def plugin_info_view(request):
    plugin_information = [
        ...
        'description' : ['Company Holiday Calender Plugin is a zuri.chat plugin  that enables  calender functions mainly to organize or schedule holidays or events for a company or a team']},
