      ...
      {eventData.data ? (
        <div>
          ...
          <div
            ...
            style={{ display: `${addReminder ? "block" : "none"}` }}
          >
                ...
                <div className="occurrence">
                  <div className="occurrence-dropdown">
                    ...
                    >
                      ...
                      <option value="Weekly on Wednesday">
                        Weekly on Wednesday
                      </option>
                      <option value="Monthly">Monthly</option>
                      <option value="Yearly">Yearly</option>
                      <option value="Every week day (Monday to Friday)">
                        Every week day (Monday to Friday)
                      </option>
